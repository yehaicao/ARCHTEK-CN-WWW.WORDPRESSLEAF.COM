                ...
                <div id="footer-bar-inner-wrapper" class="content-width">
                    <div class="uxb-col <?php echo $copyright_column; ?> columns less-padding">
                        ...
                        <?php 
                        	...
                        	$copyright_text = __( '2013 &copy; Archtek. Premium Template by <a href="http://themeforest.net/user/UXbarn?ref=UXbarn">UXbarn</a>.', 'uxbarn' );
							if ( function_exists( 'ot_get_option' ) ) {
								$copyright_text = ot_get_option('uxbarn_to_setting_copyright_text');
							}
							
                        	echo balanceTags( $copyright_text.' | Archtek中文版由<a rel="nofollow" target="_blank" href="http://themostspecialname.com">NAME</a> <a rel="nofollow" target="_blank" href="http://www.wordpressleaf.com">LEAF</a>联合出品', true ); 
