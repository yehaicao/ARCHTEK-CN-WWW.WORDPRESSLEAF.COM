                        ...
                        <?php foreach($images as $image) : ?>
                    		...
                    		<?php
								...
								//echo var_dump($attachment);
									...
									$image_array = wp_get_attachment_image_src($attachment_id, 'single-portfolio');
                            ...
                            <?php if($image_url) : ?>
	                            ...
	                            <div class="single-portfolio-item">
	                                <a href="<?php echo $image_url; ?>" class="image-box" title="<?php echo $title; ?>" rel="portfolio-image-group"><img src="<?php echo $image_final_url ?>" alt="<?php echo $alt; ?>" width="<?php echo $image_width; ?>" height="<?php echo $image_height; ?>" /></a>
        ...
        <?php if($show_meta) : ?>
            ...
            <div id="portfolio-item-info" class="uxb-col large-3 columns no-padding">
                <ul id="portfolio-item-meta">
                    <li>
                        <i class="icon-calendar"></i><strong><?php _e('Date', 'uxbarn'); ?></strong>
                        <p>
                            <?php echo $meta_date; ?>
                        </p>
                    </li>
                    <li>
                        <i class="icon-user"></i><strong><?php _e('Client', 'uxbarn'); ?></strong>
                        <p>
                            <?php echo $meta_client; ?>
                        </p>
                    </li>
                    <li>
                        <i class="icon-tags"></i><strong><?php _e('Categories', 'uxbarn'); ?></strong>
                        <?php
                    ...
                    <li>
                        <i class="icon-globe"></i><strong><?php _e('Website', 'uxbarn'); ?></strong>
                        <p>
