(function() {
    tinymce.create('tinymce.plugins.buttonPlugin', {
        init : function(ed, url) {
            ...
            // Register buttons
            ed.addButton('uxbarn_home_shortcode_generator_button', {title : 'UXbarn Shortcode Generator', cmd : 'mcebutton', image: AdminSettings.image_path + '/admin/uxbarn_sm2.png' });
        },
