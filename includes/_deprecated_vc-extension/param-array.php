...
if(!function_exists('uxbarn_get_css_animation_param')) {
    function uxbarn_get_css_animation_param() {
        ...
        $add_css_animation = array(
          ...
          "admin_label" => false,
          "value" => array(__("No", "uxbarn") => '', __("Top to bottom", "uxbarn") => "top-to-bottom", __("Bottom to top", "uxbarn") => "bottom-to-top", __("Left to right", "uxbarn") => "left-to-right", __("Right to left", "uxbarn") => "right-to-left", __("Appear from center", "uxbarn") => "appear"),
