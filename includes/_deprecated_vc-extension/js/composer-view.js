...
(function ($) {
    ...
    var SettingsView = Backbone.View.extend({
        ...
        events:{
            ...
            // 'click .close':'close',
            // CUSTOM CODE: Additionally bind "close" to ".button" class (Cancel button)
            'click .button:not(.insert-media)':'close',
            // END: CUSTOM CODE
            'hidden':'remove',
            'hide':'askSaveData',
            'shown':'loadContent'
        ...
        askSaveData:function () {
            ...
            return false;*/
            // CUSTOM CODE: Fixed twice confirm dialog
            if (this.data_saved || (!this.data_saved)) {
                this._killEditor();
                $('body').removeClass('modal-opened');
                return true;
            }
        ...
        close:function () {
            ...
            // CUSTOM CODE: No confirmation dialog for close and cancel button
            this.data_saved = true;
            this._killEditor();
            this.$el.modal('hide'); 
            $('body').removeClass('modal-opened');
